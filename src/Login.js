...
class Login extends Component {
  ...
  render(){
    ...
    if(this.state.redirect){
      ...
      return(
        <Redirect test="test" from="/bullshit" to={{
    ...
    return (
      <div className="container registration-page">
        ...
        <div className="col-xs-12 col-sm-5 col-sm-offset-1 descriptor">
          ...
          <div className="col-xs-12 col-sm-4 ">
            ...
            <input type="text" placeholder="email" value={this.state.login.email}
            onChange={e => this.setState({
              login: { email : e.target.value, password: this.state.login.password}
            })} />

            <input type="password" placeholder="password" value={this.state.login.password}
            onChange={e => this.setState({
